...
function validateMedia(event, expectedType) {
  ...
  assert(event.fileID.includes('/quick-entry/'), 'MEDIA_INVALID', '临时媒体路径不正确')
  return event.fileID
}

module.exports = { assert, assertNoClientIdentity, fail, validateMedia, validateText }
